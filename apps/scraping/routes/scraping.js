...
module.exports = (app) => {
  const scrapController = require('../controllers/scraping')(app);
  /**
   * Scrap routes.
   */
  ...
  router.post('/new', (req, res, next) => {
    return scrapController.postNew(req)
      .then(() => res.redirect(app.path()))
      .catch(errors => {
        req.flash('errors', errors);
        return res.redirect(`${app.path()}/new`);
      })
  })
  ...
  router.post('/edit/:id', (req, res, next) => {
    return scrapController.updateScrap(req)
      ...
      .catch(errors => {
        req.flash('errors', errors);
        return res.redirect(`${app.path()}/edit/${req.params.id}`)
      })
  })
  ...
  router.delete('/delete/:id', (req, res, next) => {
    return scrapController.deleteScrap(req)
      ...
      .catch(errors => {
        req.flash('errors', errors);
        return res.redirect(`${app.path()}/${req.params.id}`)
      })
  })
